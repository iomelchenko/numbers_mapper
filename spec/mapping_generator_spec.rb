describe MappingGenerator do
  ...
  it "should create valid mapping for phone_number 6686787825" do
    expect(MappingGenerator.new(phone_number_1).execute).to eql phone_numbers_mapping[phone_number_1]
  end

  it "should create valid mapping for phone_number 2282668687" do
    expect(MappingGenerator.new(phone_number_2).execute).to eql phone_numbers_mapping[phone_number_2]
  end
end
